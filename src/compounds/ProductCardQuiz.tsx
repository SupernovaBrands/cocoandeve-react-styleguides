	...
	return (
		<figure className={props.className ?? ''}>
            <a href={props.href ?? '/pages/self-tan-quiz'}>
                ...
                <figcaption className={`${props.heading === 'SPF Quiz' ? 'left-0 w-[100%]' : 'left-[5em] w-[75%] pl-25 pr-g'} absolute top-2/4 lg:top-0 lg:left-0 lg:right-0 -translate-y-1/2 lg:transform-none text-left lg:text-center lg:px-0 lg:mt-4 lg:pt-0 pb-0 lg:pb-0 lg:w-full items-center [flex-flow:column] justify-center`}>
                    <p className={`lg:text-xl mb-0 lg:mb-25 font-bold text-body w-full ${props.heading === 'SPF Quiz' ? 'text-lg text-center' : ''}`}>{props.heading ?? 'Tan Quiz'}</p>
