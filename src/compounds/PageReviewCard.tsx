...
const PageReviewCard = (props:any) => {
    ...
    return (
        <div key={props.keyName} className='bg-gray-400 rounded-[32px] review-comparision-card flex-col-reverse lg:flex-row relative mb-0 lg:mb-0 flex-grow-0 flex-shrink-0 flex lg:w-[100%] lg:basis-[100%] w-[85%] basis-[85%] pl-[16px] pr-[16px] pt-[16px] lg:px-g text-center'>
            <div className='review-comparision-card__content w-[100%] lg:w-1/2 text-left align-items-center justify-center flex pt-[16px] lg:pt-[60px] pb-[16px] lg:pb-[60px]'>
                <div className='flex flex-wrap pl-[16px] pr-[16px] lg:pl-[30px] lg:pr-[30px] max-w-[440px]'>
                    <h3 className='mb-[16px] '>{data?.product_title}</h3>
