			...
			<div className="border-b border-gray-400 w-full border-t">
				<div className="bg-white px-g">
					<div className="container relative flex items-center px-0 lg:px-g">
						...
						<input type="text" placeholder={content?.search_input_placeholder} name="q" className="placeholder:text-body w-full py-2 pl-4 lg:pl-4 border-0 focus:outline-none text-body" aria-label="search" onChange={onChange} value={keyword} />
