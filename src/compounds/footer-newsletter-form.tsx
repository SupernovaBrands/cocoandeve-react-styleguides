	...
	return (
		<form className={`w-full ${props.classes}`} onSubmit={(e) => props.onSubmit(e)}>
			<div className="relative flex items-stretch w-full">
				<input defaultValue={props.email} required type="email" className={`${props.background ? props.background : 'bg-gray-400' } flex-[1_1_auto] w-[1%] focus:outline-none focus:border-gray-400 active:border-gray-400  focus-visible:border-gray-400 block appearance-none px-[1rem] py-[14px] mb-0 text-base leading-base border border-[solid] border-gray-400 text-body placeholder:text-gray-800 border-gray-200 rounded-tl-[4px] rounded-bl-[4px] -mr-1`} placeholder={`${props.placeholder ? props.placeholder : 'Enter your email' }`} aria-label={`${props.placeholder ? props.placeholder : 'Enter your email' }`} />
