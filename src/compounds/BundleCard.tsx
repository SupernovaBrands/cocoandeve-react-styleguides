...
const BundleCard = (props:any) => {
    const { setItemSelected, itemSelected, smSingleStar, addToCart, trackEvent, carousel, eventNameOnClick, preOrders, generalSetting, label, store, smSingleStarAllDevice, sideUpsell } = props;
