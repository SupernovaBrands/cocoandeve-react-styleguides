        ...
        <>
            <div className={`product-waitlist bg-yellow-light product-waitlist__form w-100 p-3 mb-3 rounded text-center ${props.className}`}>
                ...
                <form data-pdp="false" data-product-id="product-id">
                    ...
                    <div className="flex flex-wrap">
                        <Select border={false} groupClass="block w-1/4 relative pl-2 pr-0" id="select-countries" placeholder="Select Country" masking={true} options={[{maskValue: '+65', value: 'SG', label: 'Singapore'}, {maskValue: '+1', value: 'US', label: 'United States'}]} selected="SG"></Select>
