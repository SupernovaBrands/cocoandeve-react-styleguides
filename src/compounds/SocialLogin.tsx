const SocialLogin = (props: any) => {
	return (
		<div className="auth-buttons CustomerLoginForm">
			<a className="btn btn-outline-dark mb-2 text-gray-600 bg-white btn-block flex items-center justify-center" href="https://www.facebook.com/dialog/oauth?client_id=245452109181281&amp;redirect_uri=https://s-app.cocoandeve.com/auth/facebook&amp;scope=email&amp;ret=login&amp;state=cocoandeve_shopify_dev">
			...
			<a className="btn btn-outline-dark mb-2 text-gray-600 bg-white btn-block flex items-center justify-center" href="https://accounts.google.com/o/oauth2/v2/auth?scope=https%3A//www.googleapis.com/auth/userinfo.profile%20https%3A//www.googleapis.com/auth/userinfo.email&amp;access_type=offline&amp;include_granted_scopes=true&amp;response_type=code&amp;state=cocoandeve_shopify_dev&amp;redirect_uri=https://s-app.cocoandeve.com/auth/google&amp;client_id=449650008430-lrrbgmjrlsjfac2vq2bc02h66idqjjtu.apps.googleusercontent.com">
