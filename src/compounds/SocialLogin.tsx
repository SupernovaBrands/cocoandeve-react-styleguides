const SocialLogin = (props: any) => {
	...
	return (
		<div className="auth-buttons CustomerLoginForm">
			<a className="btn btn-outline-dark mb-2 text-gray-600 bg-white btn-block flex items-center justify-center" href={facebookLogin}>
			...
			<a className="btn btn-outline-dark mb-2 text-gray-600 bg-white btn-block flex items-center justify-center" href={googleLogin}>
