...
const SingleStar = ({score}) => (
	<>
		<svg className="w-[14px] h-[14px]" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="#151515">
		...
		<span className="pl-[.25rem] text-gray-600">5.0</span>
	</>
)
		...
		<div className="w-full lg:w-1/3 lg:inline-block result-card sm:px-hg">
			...
			<div className="py-[1rem] px-[12px] bg-white rounded-none mb-2">
				<div className="flex items-center mb-[8px] gap-[12px]">
					...
					<div className="flex items-center result-card__stars" aria-hidden="true" >
						<span className={`flex text-sm lg:text-base ${platform === 'os-mac' || platform === 'os-ios' ? 'leading-[18px!important]' : 'leading-[12px!important]'} review-stars__link`}>
							<SingleStar score={5.0} />
						</span>
					</div>
				</div>
				{region === 'au' ? (
