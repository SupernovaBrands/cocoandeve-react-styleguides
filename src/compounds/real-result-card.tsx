...
const RealResultCard = (props) => {
	...
	let titleDesc = `className="underline ml-[8px] text-body" aria-label="${children}" title="Go To Product Page - `;
	...
	return (
		<div className="w-full lg:w-1/3 lg:inline-block result-card sm:px-hg lg:px-g">
			...
			<div className="px-2 pb-2 pt-2 bg-white rounded-none mb-2 lg:mb-3">
				<div className="flex items-center mb-1">
					...
					<div className="ml-[12px] flex text-[16px] leading-[18px] review-stars__link">
						<SingleStar />
						<span className="ml-[3px] leading-[11px] text-gray-600">5.0</span>
					</div>
				</div>
				{region === 'au' ? (
