                ...
                <figure className="flex">
                    {urlSet && bundleImg && (
                        <a href={`/products/${urlSet}`} className="block w-[34.7%] lg:w-[26.38%] aspect-[120/260] lg:aspect-[124/174]">
                            <img loading="lazy" className="w-full h-full object-cover" src={imageSrc} alt={`Save with Sets ${optionValue.replace('1x ', '')}`} width={120} height={260} />
                        </a>
                    )}

                    {!urlSet && bundleImg && (
                        <img loading="lazy" alt={`Save with Sets ${optionValue.replace('1x ', '')}`} className="aspect-[120/260]  lg:aspect-[124/174] w-[34.7%] lg:w-[26.38%] object-cover" src={imageSrc} width={120} height={260} />
                    )}
