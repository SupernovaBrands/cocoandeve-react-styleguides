            ...
            {data.result && (
                <section className="my-3 lg:mb-5 lg:mt-5 container px-0">
                    ...
                    <div className="text-center mt-[.25rem] lg:mt-3">
                        <a href="/pages/reviews" className="instagram-reels__button btn btn-lg btn-outline-primary rounded-full border-2 lg:border-[1px] hover:no-underline px-[4em] py-[.8125em] lg:py-[.875em] inline-block lg:w-[158px] lg:px-1">
                            See All
                        </a>
                    </div>
                </section>
