    ...
    const PACKAGING = [
        {
			...
			comment: 'Need to bin something? All our packaging is 100% recyclable. Only our travel size tube caps and bottle caps are made from plastic which might be hard to recycle (depending on which country you live in). And you can rest assured we’re working hard to ensure they’re soon recyclable across the world!'
		},
        {
			id: 1,
			src: 'https://via.placeholder.com/530x378.jpg/EFADBA',
		...
		<>
            ...
            <section className="sustainability-banner position-relative">
                <a href="#">
                    <picture>
                        ...
                        <img className="d-block w-100" alt="/" src="https://via.placeholder.com/375x260.jpg/EFADBA" alt="Paradise lost? Not on our watch!" />
                    </picture>
                ...
                <div className="row bg-primary-light mx-0">
                    <div className="col-12 col-lg-7 px-0">
                        <picture>
                            ...
                            <img className="fit--cover w-100" alt="/" src="https://via.placeholder.com/375x320.jpg/EFADBA" alt="What are we doing?" />
                        </picture>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-lg-6 order-lg-2">
                            ...
                            <Tabs
                                ...
                                id="product-benefits-tab"
                                className="mb-2 justify-content-center justify-content-lg-start"
                            >
                                <Tab eventKey="new" title="Finest ingredients" tabClassName="nav-link text-decoration-none mb-0 mx-0 mx-lg-1 font-weight-normal">
                                ...
                                <Tab eventKey="bestsellers" title="Microbead-free" tabClassName="nav-link text-decoration-none mb-0  mx-0 mx-lg-1 font-weight-normal">
                                ...
                                <Tab eventKey="value-sets" title="FAQ" tabClassName="nav-link text-decoration-none mb-0 mx-0 mx-lg-1 font-weight-normal">
            ...
            <section className="pt-4 pb-4 position-relative">
                <div className="container p-0 p-md-1">
                    ...
                    <CarouselCustom packaging={true} items={PACKAGING} id="packaging" slideNumber={4} centered={true} className="position-relative mb-5 col-9 col-md-3 product-card text-center" carouselClass="pt-2" />
                </div>
            </section>
