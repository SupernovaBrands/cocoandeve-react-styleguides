...
const Stockist = (props: any) => {
    ...
    return (
        <>
            <section className="container stockist px-g">
                        ...
                        <Carousel.Inner emblaRef={emblaRef2} className="flex lg:flex-wrap gap-0 lg:gap-[16px] pb-2 lg:pb-0">
                            {stores.map((filteredItem, idx) => (
                                <figure key={filteredItem.id} className="m-0 flex-[0_0_40%] md:flex-[0_0_20%] lg:flex-none lg:w-[calc((100%-64px)/5)]" data-toggle={filteredItem.country_tag}>
                                    <a href={filteredItem.logo_url} target="_blank" className="block rounded-none">
                                        <img className="mx-auto !w-auto h-[40px] lg:h-[60px]" src={filteredItem.logo.url} alt={filteredItem.logo.alt || `Stockist logo ${filteredItem.title} ${idx}`} />
                                    </a>
                    ...
                    <div className="grid gap-y-[.75rem] md:grid-cols-2 md:gap-x-[1rem] xl:grid-cols-[572px_572px] px-0 lg:px-25">
                        ...
                        <figure className="relative">
                            ...
                            <figcaption className="text-body text-left absolute top-0 bottom-0 left-0 right-0 p-[0.75rem] lg:p-[1.5rem] flex flex-col">
                                <p className="hidden lg:block text-xl mb-[.5rem] font-bold">Beauty With Confidence</p>
                ...
                {/* <div className="flex my-3 flex-wrap lg:-mx-g lg:mt-5">
                    ...
                    <figure className="lg:grid lg:grid-cols-[1fr] lg:items-center relative">
                        <picture className="block">
                            <source srcSet="https://cdn.shopify.com/s/files/1/0286/1327/9779/files/discovermore_services_m.jpg?v=1771217468" media="(min-width: 992px)" />
                            <img className="w-full h-[88px] lg:h-auto" src="https://cdn.shopify.com/s/files/1/0286/1327/9779/files/discovermore_services_m.jpg?v=1771217468" loading="lazy" alt="Cocoandeve overview review" width={384} height={88} />
                        </picture>
