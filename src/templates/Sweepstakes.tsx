...
const Sweepstakes = (props) => {
    ...
    return (
        <>
            <section className="sweepstakes bg-primary-light" style={isDesktop ? backgroundStyleDesktop : backgroundStyle}>
                    ...
                    <div className="flex flex-wrap m-0 items-center place-content-end">
                        <div className="sweepstakes__content px-g lg:w-5/12 lg:order-1 lg:my-4">
                            ...
                            <div className="social-icon flex justify-center mt-4 mb-4">
								<a className="mx-1 mt-[5px]" href="https://www.facebook.com/cocoandeve" target="_blank" rel="noreferrer">
								...
								<a className="mx-1 mt-[5px]" href="https://www.instagram.com/cocoandeve/" target="_blank" rel="noreferrer">
								...
								<a className="mx-1 mt-[5px]" href={tiktokUrl} target="_blank" rel="noreferrer">
