            ...
            <section>
                <div className="container lg:max-w-[1200px] pt-5 lg:pt-2 pb-0 lg:pb-0">
                    ...
                    <div className="flex flex-col -mx-hg lg:-mx-g text-center justify-center pb-4 pt-3">
                        ...
                        <p>No worries, you can contact us <a aria-label="Contact us here" className="text-underline" href="https://support.cocoandeve.com/en-GB" title="https://support.cocoandeve.com/en-GB">here</a>.</p>
                    </div>
                </div>
            </section>
        </>
