                        ...
                        <div className="row  m-0">
                            <div className="col-12 col-lg-8 p-0">
                                <a href="#" target="_blank"  className='d-block instagram--feed--link'>
                                    <picture>
                                    <source srcset="https://via.placeholder.com/176x176"/>
                                    <img className="w-100 img-big" src="https://via.placeholder.com/176x176" />
                                    </picture>
                                </a>
                            </div>
                                ...
                                <div className="row  m-0 ">
                                    <div className="col-lg-12 col-6 p-0">
                                        <a href="#" target="_blank"  className='d-block instagram--feed--link'>
                                            <picture>
                                            <source srcset="https://via.placeholder.com/176x176"/>
                                            <img className="w-100" src="https://via.placeholder.com/176x176" />
                                            </picture>
                                        </a>
                                    </div>
