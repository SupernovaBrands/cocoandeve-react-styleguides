                ...
                <div className="text-center instagram-reels__video-container pl-hg lg:pl-0">
					<div className="lg:flex lg:flex-wrap lg:justify-between">
						...
						{ !props.show && (<ul className="instagram-reels__nav hide-scrollbar list-style-none mx-auto flex border-b-0 text-center justify-start px-hg flex-nowrap overflow-scroll mb-g lg:overflow-hidden lg:mx-0 lg:px-0">
							{!['int'].includes(store) && (<li key={`all`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'all' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='All' active={activeTab === 'all'} onNavChange={() => setActiveTab('all')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int'].includes(store) && (<li key={`hair`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'hair' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='Hair' active={activeTab === 'hair'} onNavChange={() => setActiveTab('hair')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'my'].includes(store) && (<li key={`tan`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'tan' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='Tan' active={activeTab === 'tan'} onNavChange={() => setActiveTab('tan')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int'].includes(store) && (<li key={`spf`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'spf' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='SPF' active={activeTab === 'spf'} onNavChange={() => setActiveTab('spf')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'ca', 'au', 'eu', 'us'].includes(store) && (<li key={`skincare`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'skin' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='Skin' active={activeTab === 'skin'} onNavChange={() => setActiveTab('skin')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'my'].includes(store) && (<li key={`body`}><TabNav className={`bg-gray-400 mr-1 whitespace-nowrap rounded-full py-25 lg:py-1 px-2 lg:text-base ${activeTab === 'body' ? 'instagram-reels__nav--active font-normal bg-primary' : 'text-gray-600'}`} title='Body' active={activeTab === 'body'} onNavChange={() => setActiveTab('body')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
						</ul>) }
