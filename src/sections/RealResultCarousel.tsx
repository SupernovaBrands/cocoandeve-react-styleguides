			...
			<div className="row">
                <div className="text-center instagram-reels__video-container pl-hg lg:px-25">
					<div className="lg:flex lg:flex-wrap lg:justify-between lg:items-center lg:mb-3">
						{ !props.show && (<ul className="instagram-reels__nav gap-0 lg:gap-[.375rem] hide-scrollbar list-style-none mx-auto flex border-b-0 text-center justify-center lg:justify-start px-hg flex-nowrap overflow-scroll mb-[1rem] lg:mb-0 lg:overflow-hidden lg:mx-0 lg:px-0">
