			...
			<div className="row">
                <div className="text-center instagram-reels__video-container pl-hg lg:px-25">
					<div className="lg:flex lg:flex-wrap lg:justify-between lg:items-center lg:mb-3">
						{ !props.show && (<ul className="instagram-reels__nav gap-[.5rem] lg:gap-[.375rem] hide-scrollbar list-style-none mx-auto flex border-b-0 text-center justify-center lg:justify-start px-hg flex-nowrap overflow-scroll mb-[1rem] lg:mb-0 lg:overflow-hidden lg:mx-0 lg:px-0">
							{!['int'].includes(store) && (<li className="flex items-center" key={`all`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'all' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='All' active={activeTab === 'all'} onNavChange={() => setActiveTab('all')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int'].includes(store) && (<li className="flex items-center" key={`hair`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'hair' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='Hair' active={activeTab === 'hair'} onNavChange={() => setActiveTab('hair')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'my'].includes(store) && (
								<li className="flex items-center" key={`tan`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'tan' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='Tan' active={activeTab === 'tan'} onNavChange={() => setActiveTab('tan')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>
							)}
							{!['int'].includes(store) && (<li className="flex items-center" key={`spf`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'spf' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='SPF' active={activeTab === 'spf'} onNavChange={() => setActiveTab('spf')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'ca', 'au', 'eu', 'us'].includes(store) && (<li className="flex items-center" key={`skincare`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'skin' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='Skin' active={activeTab === 'skin'} onNavChange={() => setActiveTab('skin')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'my'].includes(store) && (
								<li className="flex items-center" key={`body`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'body' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='Body' active={activeTab === 'body'} onNavChange={() => setActiveTab('body')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>
							)}
						</ul>) }
