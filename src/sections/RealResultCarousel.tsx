                ...
                <div className="text-center instagram-reels__video-container pl-hg lg:px-25">
					<div className="lg:flex lg:flex-wrap lg:justify-between lg:items-center lg:mb-3">
						{ !props.show && (<ul className="instagram-reels__nav gap-0 lg:gap-[.375rem] hide-scrollbar list-style-none mx-auto flex border-b-0 text-center justify-center lg:justify-start px-hg flex-nowrap overflow-scroll mb-[1rem] lg:mb-0 lg:overflow-hidden lg:mx-0 lg:px-0">
							{!['int', 'my'].includes(store) && (<li className="flex items-center" key={`all`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'all' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='All' active={activeTab === 'all'} onNavChange={() => setActiveTab('all')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
							{!['int', 'my'].includes(store) && (<li className="flex items-center" key={`hair`}><TabNav className={`whitespace-nowrap py-[.5rem] lg:py-1 px-[.5rem] lg:px-2 lg:text-base lg:leading-[25px] ${activeTab === 'hair' ? 'instagram-reels__nav--active font-normal lg:bg-body lg:text-white lg:focus:text-white lg:visited:text-white lg:hover:text-white' : 'text-gray-600'}`} title='Hair' active={activeTab === 'hair'} onNavChange={() => setActiveTab('hair')} ctaBgColor={generalSetting?.bfcm_cta_bg_color} ctaTextColor={generalSetting?.bfcm_cta_text_color} /></li>)}
