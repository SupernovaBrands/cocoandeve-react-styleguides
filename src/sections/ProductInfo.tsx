...
const ProductInfo = (props: any) => {
    const [ingredients, setIngredients] = useState(CONTENT_INGREDIENTS);
    ...
    const onIngAccordionChange = (i) => {
        ...
        setIngredients(ingredientsContent);
        ...
        <>
            <div className={`px-0 text-center`}>
                <div className="container lg:flex lg:justify-between">
                    <h2 className="container text-xl lg:text-2xl text-center mb-g lg:mx-0 lg:text-left">{'Meet Bronzing Face Drops'}</h2>
                    ...
                    <div className='container py-[50px]'>
                        <ul className='flex gap-g flex-col lg:flex-row'>
                            {ingredients.map((item, i) => {
                                return (
                                    <li className={`flex-1 border-b-[#ADADAD] border-b border-solid ${i === 0 ? 'border-t-[#ADADAD] border-t border-solid' : ''}`}> 
                                        ...
                                        <div className={`bg-white py-[16px] lg:p-[16px] rounded-[20px] text-left ${!item.open ? 'hidden' : 'block'}`}>
                ...
                <div className={`flex flex-col-reverse lg:flex-row mx-0 mb-0 flex-wrap bg-yellow-light ${activeTab === 'how_to_use' ? 'block' : 'hidden'} `}>
                    <div className={`product__banner-left lg:w-1/2 text-left flex justify-center`}>
                        <div className={`product__banner-content lg:min-h-[420px] lg:max-w-[535px] flex justify-center flex-col`}>
                            <h2 className="lg:text-[32px] mb-2 lg:mb-4">How to use Bronzing Face Drops</h2>
                            <ul>
                                <li className="flex mb-[16px]">
                                    <span className="text-[#BA3373] text-center text-[40px] font-bold flex-[0_0_20px]">1</span>
                                    <p className="ml-g">Shake it! Gently press the button at the end of the applicator to release the drops. Add 2-3 drops to your chosen moisturiser in the palm of your hand.</p>
                                </li>
                                <li className="flex">
                                    <span className="text-[#BA3373] text-center text-[40px] font-bold flex-[0_0_20px]">2</span>
                                    <p className="ml-g">Apply evenly over the face, neck and blend with your hairline. Wash hands thoroughly after use. Apply daily for a gradual, buildable natural tan!</p>
                                </li>
                            </ul>
                        </div>
                    </div>
