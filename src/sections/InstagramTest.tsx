            ...
            <div className="container instagram--feed container-fluid lg:px-3 sm:px-hg">
                <div className="flex flex-wrap lg:-mx-g sm:-mx-hg">
                    <div className="w-11/12 lg:w-7/12 text-center mx-auto pb-g sm:px-hg instagram__caption">
                        ...
                        <p className="instagram__desc font-normal mb-0">
                            {props.desc ? (
                                <>{props.desc}</>
                            ) : (
                ...
                {data?.length > 0 && (
                    <div className="p-1 lg:p-0 instagram__feeds">
                        <div className="flex flex-nowrap sm:p-0 sm:pb-1 md:p-1 -mx-hg lg:-mx-g px-hg lg:-px-g instagram__feeds-container">
                                    ...
                                    {data && data.length && (
                                        <div className="w-1/2 lg:w-[28.570%] lg:basis-[28.570%] hidden lg:block">
                                            <a href={data[0].link} target="_blank" className='block instagram--feed--link p-25' aria-label="Visit Instagram profile">
                                                <picture>
                                                    <source srcSet={data[0].image}/>
                                                    <img className="w-full aspect-square object-cover" src={data[0].image} />
                                                </picture>
                                            </a>
                                        </div>
                                    )}
