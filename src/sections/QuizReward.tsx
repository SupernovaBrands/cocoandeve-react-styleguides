...
const AWARD_SVG = `<svg class="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" width="17" height="19" viewBox="0 0 17 19" fill="none">
...
const MONEY_BACK = `<svg class="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
...
const STAR = `<svg class="w-[18px] h-[18px]" xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
...
const QuizReward = (props: any) => {
    ...
    return (
        <section ref={sectionRef} className="container text-center my-5">
            <p className={`text-xl lg:text-2xl mb-[.75rem] ${store === 'my' ? 'lg:mb-2' : 'lg:mb-3'} font-bold`}>
                {store === 'my' ? 'Tried, Tested & Loved' : 'Discover more'}
            </p>
                        ...
                        <figure className="relative">
                            <a href="/pages/rewards" className="block relative">
                                ...
                                <figcaption className="text-body text-left absolute top-0 bottom-0 left-0 right-0 p-[1rem] lg:p-[1.5rem] flex flex-col justify-between">
                                    ...
                                    <span className="text-underline text-left text-body hover:text-primary transition-colors font-bold underline-offset-[.125rem] text-sm lg:text-base leading-2 w-fit">Join Now</span>
                                </figcaption>
                            </a>
                        </figure>  
                    )}
