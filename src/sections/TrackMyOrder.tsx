        ...
        <>
            <section>
                <div className="container max-w-screen-lg py-4">
                    <div className="flex flex-wrap -mx-hg lg:-mx-g text-center justify-center">
                        ...
                        <div className="w-1/2 pt-3 pb-3 mb-2">
                            <form className="form-group w-full" onSubmit={tracking}>
                                ...
                                <button type="submit" className='btn btn-primary w-100 block mt-g py-g w-full'>Track Order</button>
                            </form>
                        </div>
                    </div>
                    {showDelivery && dataTracking && (
                        <>
                            {!dataTracking?.fulfillment && !dataTracking?.order ? (
                                <p className="no_data_message">We are not able to find tracking details. If you have just placed the order, please allow two business days for the order to be fulfilled. You will receive a shipping notification email once the order is shipped. Otherwise, please <a href="https://support.cocoandeve.com/hc/en-us/requests/ne">contact us</a> for help.</p>
                            ) : (
                                <>
                                    <div className='flex flex-wrap w-full justify-center'>
                                        {dataTracking?.fulfillment?.tracking_url && (
                                            <>
                                                <h2 className="mt-2 mb-1 text-base">Your Order has been picked up by our Shipping Partner.</h2>
                                    ...
                                    <div className='flex flex-wrap w-full justify-center border-b-solid border-b-[1px] border-b-[#e6e6e6] pb-1'>
                                        ...
                                        <div className="track-step-container flex lg:w-[70%] lg:mx-[auto] my-[40px]">
                                            ...
                                            <div className="track-step track-pickup active text-center flex justify-center [flex-flow:column] items-center">
                                                ...
                                                <span className='block text-[12px] mt-[3px] h-[100px]'>Pick Up</span>
                                            </div>
                                            <div className="track-line w-1/5 mt-[5%] block mx-[auto] my-[0] h-[2px] bg-[#d1d1d1]"></div>
                                            <div className="track-step track-intransit active text-center flex justify-center [flex-flow:column] items-center">
                                                ...
                                                <span className='block text-[12px] mt-[3px] h-[100px]'>In Transit</span>
                                            </div>
                                            <div className="track-line w-1/5 mt-[5%] block mx-[auto] my-[0] h-[2px] bg-[#d1d1d1]"></div>
                                            <div className="track-step track-delivered active text-center flex justify-center [flex-flow:column] items-center">
                                                ...
                                                <span className='block text-[12px] mt-[3px] h-[100px]'>Delivered</span>
                                            </div>
                                        </div>
                                        ...
                                        <p className='mb-1'>Your order is on its way</p>
                                        )}
                                        {dataTracking?.status === 'pickup' && (
                                            <p className='mb-1'>Your order has been picked up</p>
                                        )}
                                        {dataTracking?.status === 'delivered' && (
                                            <p className='mb-1'>Your order has been delivered</p>
                                        )}
                                        
                                    </div>
                                    <div className='flex flex-wrap w-full justify-center pb-[10px] pt-3 border-b-[1px_solid_#e6e6e6]'>
