                    ...
                    <div className="flex flex-wrap lg:-mx-g text-center justify-center">
                        ...
                        <div className="lg:w-[57%] pt-2 lg:mb-2">
                            <form className="form-group w-full" onSubmit={tracking}>
                                ...
                                <button type="submit" className={`mb-1 btn ${generalSetting?.bfcm_cta_bg_color === 'bg-dark' ? 'bg-dark border-dark text-white hover:bg-dark' : 'btn-primary'} w-100 block mt-g py-g w-full rounded`}>{submitBtn}</button>
                            </form>
                        </div>
                    </div>
