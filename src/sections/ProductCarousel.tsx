				...
				<div>
					<div className="product__carousel-nav-container">
						<ul className="product__carousel-nav list-style-none mx-auto flex flex-wrap border-b-0 text-center pb-4 lg:pb-2 justify-center">
							...
							<li><TabNav className={`!leading-[2.3] w-[7.5rem] lg:w-[9.375rem] px-g hover:text-body focus:text-body visited:text-body lg:text-lg ${activeTab === 'bestsellers' ? 'text-body font-bold' : ''}`} title={`${smallerTest ? 'Best Sellers' : 'Bestsellers'}`} active={activeTab === 'bestsellers'} onNavChange={() => setActiveTab('bestsellers')} /></li>
