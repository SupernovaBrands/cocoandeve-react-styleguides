            ...
            <div className="relative mb-3 lg:mb-2 flex max-h-[64px] lg:min-h-[97px] rounded-[24px] lg:rounded-[32px] bg-yellow-light items-center justify-between pr-2">
                <div className="flex items-center">
                    ...
                    <div className="lg:order-1 ml-g lg:ml-2">
                        <p className="font-bold lg:mb-25 lg:text-lg" dangerouslySetInnerHTML={{__html: `Tan Quiz<span class="lg:hidden">: Find your perfect shade</span>`}} />
                        <div className="hidden lg:block text-sm">Find the perfect shade to match <br />your skin’s needs 3 minutes!</div>
                    </div>
