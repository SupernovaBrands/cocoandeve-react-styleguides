		...
		<div id="yotpoReviewForm" className="collapse mt-3" data-parent="#yotpoFormCollapse">
			<div className="yotpo__review-fields d-flex flex-column">
				...
				<div className="form-group">
					...
					<input type="text" className="form-control mb-1" id="yotpoFormTitle" value={title} onChange={(e) => setTitle(e.target.value)} required aria-label="review form title" />
				...
				<div className="form-group">
					...
					<textarea className="form-control mb-1" id="yotpoFormReview" value={review} onChange={(e) => setReview(e.target.value)} rows="5" aria-label="review form" />
				...
				<div className="row mx-0 mx-lg-ng mb-3 justify-content-lg-end">
					...
					<div className="col-lg-4 px-0 px-lg-g">
						...
						<input type="email" id="yotpoReviewEmail" className="form-control mb-1" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required aria-label="review form email" />
