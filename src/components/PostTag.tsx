...
const PostTag: React.FC<PropType> = (props) => {
	...
	return (
		<span className={`align-baseline whitespace-nowrap text-center inline-block leading-base px-[8px] py-[2px] rounded ${className} mr-1 mb-25 min-w-[3.375em]`}>{children}</span>
	)
};
