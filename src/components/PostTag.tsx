...
const PostTag: React.FC<PropType> = (props) => {
	...
	return (
		<span onClick={(e) => handleTag(e, tag)} className={`${paddingClass} font-[400] cursor-pointer inline-block badge no-underline hover:no-underline text-center rounded-[2px] ${className} ${widthClass}`}>{children}</span>
	)
};
