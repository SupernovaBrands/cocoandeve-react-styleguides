										...
										{isDesktop && (
											<>
												<picture>
													...
													<img alt={`Thumbnail image of Product Video`} className="w-[70px]" src={`${videoThumbnail || slides[0].src.replace('1140x1140', '150x150').replace('/public', '/150x').replace('_text_', `${slides.length + 1}`)}`} width={70} height={70} />
												</picture>
