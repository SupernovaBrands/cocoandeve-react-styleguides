    ...
    return (
        <label htmlFor={id} className="flex justify-content-center my-1 relative pl-3">
            ...
            <span
                ...
                className={`before:content-[''] before:size-[17.5px] before:absolute before:left-0 before:border before:inline-block before:rounded before:mr-1 ${isChecked ? 'before:bg-checkbox-checked before:border-primary' : ''}`}
            ></span>
        </label>
    );
};
