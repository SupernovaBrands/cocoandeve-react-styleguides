        ...
        <>
            <div className="py-g cart-drawer__discount-form">
                <div className={`${state.hasCode ? 'hidden' : 'flex'} flex-nowrap py-0`}>
                    ...
                    <Button
                        lg={false}
                        buttonClass={`w-1/4 px-1 min-w-[100px] ${state.code ? 'btn-outline-primary hover:underline' : 'border-black text-black'}`}
                ...
                { !state.isApplied && state.error && <p className="text-primary my-1 text-[14px]">{state.error}</p> }
