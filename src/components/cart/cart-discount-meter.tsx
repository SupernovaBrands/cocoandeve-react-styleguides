...
const CartDiscountMeter = (props) => {
	...
	const totalDiscounted = items.filter((it) => it.attributes.find((attr) => attr.key === '_campaign_type' && attr.value !== 'build_your_own_bundle')).reduce((n: any, { totalDiscountAmount }) => n + totalDiscountAmount, 0);
