    ...
    return (
        <div className="lg:text-right relative">
            <div className="relative">
                ...
                <div className={`-ml-2 absolute left-0 bg-white  text-base z-50 list-none  rounded [transition:all_0.3s] opacity-0 h-[0] top-[0] ${direction === 'dropup' ? '[transform:translate3d(0,_0,_0)]' : '[transform:translate3d(0,_20px,_0)]'} bottom-[0] overflow-hidden ${!open ? '' : openClasses }`}>
