...
const InputCountry = (props: any) => {
	...
	return (
		<>
			<label htmlFor={props.id} className={`input-group-addon border border-[#f5f5f5] relative py-[14px] px-[16px] mb-0 block appearance-none ${props.className ? props.className : 'bg-white'} rounded rounded-tr-none rounded-br-none h-[3.125rem] w-[5.063rem] lg:w-[5.688rem]`}>
