...
const VideoCard = (props) => {
	return !props.useCardTemplate ? (
		<div className={`${props.useCarousel ? 'mb-0 carousel-item col-9 col-lg-4' : ''} video-card ${props.useCarousel && props.activeIndex === props.item.index ? 'active ' : ''} ${props.itemMovingNext ? 'carousel-item-next carousel-item-start ' : ''} ${props.itemMovingPrev ? 'carousel-item-prev carousel-item-end ' : ''}`}>
