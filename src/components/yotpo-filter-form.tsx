    ...
    return (
        <div id={ id ?? 'yotpoFilterForm'} className={`${className ?? ''}`}>
			...
			<div className="flex flex-wrap mt-1 w-full review__filter-form-inputs mx-0">
				<div className="w-1/2 lg:w-full pl-0 pr-0 pl-0 pr-hg lg:px-0">
				...
				<div className="w-1/2 lg:w-full pr-0 pl-hg lg:px-0">
				...
				{customFilter.map((q, i) => q.filter !== '' && (
					<div key={q.slug} className={`w-1/2 lg:w-full pr-0 lg:px-0 ${i % 2 === 0 ? 'pl-0 pr-hg' : 'pl-hg'}`}>
