const InstagramCard = (props: any) => {
    ...
    return (
        <div className={`text-left rounded ${classes}`}>
            <video preload={props.index === 1 ? 'metadata' : 'none'} className="w-full rounded mb-0 lazy-video bg-shimmer lg:min-h-[386px] min-h-[364px]" muted={true} loop={true} webkit-playsinline="true" autoPlay={true}>
