const InstagramCard = (props: any) => {
    ...
    return (
        <div className={`text-left rounded ${classes}`}>
            <video preload={props.index === 1 ? 'metadata' : 'none'} className="w-full rounded mb-g lazy-video bg-shimmer min-h-[386px]" muted={true} loop={true} webkit-playsinline="true" autoPlay={true}>
