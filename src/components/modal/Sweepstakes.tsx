						...
						<div className="px-3 lg:px-4 py-3 lg:py-4">
							<div className="flex flex-wrap -mx-hg lg:-mx-g justify-end lg:mb-g mb-0 ">
								...
								<div className="lg:hidden w-full pl-0 lg:pl-0 text-center pr-0 lg:pr-g -mx-hg">
									...
									<p className={`lg:mb-0 lg:mt-1 font-size-sm mb-1 ${data?.sweepstakes_popup_thank_title_color ? data?.sweepstakes_popup_thank_title_color  : 'text-body'} px-0  lg:px-0`} dangerouslySetInnerHTML={{ __html: data?.sweepstakes_popup_desc }} />
								</div>
							</div>
