                ...
                <div className="flex flex-wrap flex-col justify-center items-center mx-0">
                    ...
                    {!formCompleted && (
                        <form className="relative" onSubmit={handleForm}>
                            ...
                            <p className="text-xs text-gray-600 text-center mt-1 mb-2 leading-[1.25!important]" dangerouslySetInnerHTML={{__html: nbp_note.replace('class="', 'class="text-xs leading-[1.25!important] font-bold underline ').replace('text-primary', 'text-gray-600').replace('font-normal', 'font-bold').replace('no-underline', 'underline')}} />
