...
const Waitlist = (props: any) => {
	...
	return (
		<div className="modal-content overflow-hidden bg-pink-light lg:px-g relative">
				...
				<div className="flex flex-wrap items-center justify-center">
					...
					<div className="w-full lg:w-1/2 lg:px-g text-center mt-n1 mt-lg-0">
						...
						<div className="relative flex items-stretch w-full mt-2 flex-col">
							...
							<Button type="submit" className="btn-primary w-full rounded border-0 font-bold py-g">{data.ctaText}</Button>
						</div>
					</div>
				</div>
			</div>
