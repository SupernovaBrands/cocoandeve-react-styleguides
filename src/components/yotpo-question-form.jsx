		...
		<div id="yotpoQuestionForm" className="collapse mt-3" data-parent="#yotpoFormCollapse">
			<div className="yotpo__review-fields d-flex flex-column">
				...
				<div className="form-group">
					...
					<textarea className="form-control mb-1" id="yotpoFormQuestion" value={question} onChange={(e) => setQuestion(e.target.value)} rows="5" aria-label="Question form" />
				...
				<div className="row mx-0 mx-lg-ng mb-3 justify-content-lg-end">
					<div className="col-lg-4 px-0 px-lg-g mb-1 mb-lg-0">
						...
						<input type="text" id="yotpoReviewName" className="form-control mb-1" placeholder="Your name" value={name} onChange={(e) => setName(e.target.value)} required aria-label="Question review name" />
					...
					<div className="col-lg-4 px-0 px-lg-g">
						...
						<input type="email" id="yotpoReviewEmail" className="form-control mb-1" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required aria-label="Question review email" />
