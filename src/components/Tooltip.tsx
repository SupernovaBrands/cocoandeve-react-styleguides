...
const Tooltip = (props: any) => {
	...
	return (
		<div className={`z-[1035] [transition:all_.4s_ease-in-out] left-[15px] right-[15px] lg:left-auto lg:right-[22.5px] absolute before:absolute before:top-0 before:right-0 lg:w-1/3 pr-4 pl-4 tooltip ${generalSetting?.bfcm_cta_bg_color === 'bg-dark' ? 'bg-dark' : 'bg-primary'} text-white text-center py-g overflow-hidden ${tooltipShow ? 'translate-y-[0%] visible opacity-100' : '-translate-y-full invisible opacity-0'}`}>
