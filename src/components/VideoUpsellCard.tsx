...
const VideoUpsellCard = (props: any) => {
    ...
    return (
        <div className={`text-left ${classes}`} ref={targetRef as any}>
            <p className="text-center mb-[.75rem] text-gray-600 text-base">{author}</p>
            <video preload="none" ref={videoRef}
                crossOrigin="anonymous" 
                className="lazy-video w-full mb-0 lazy-video bg-shimmer h-[376px] min-h-[376px] lg:h-[376px] lg:min-h-[376px] object-cover" muted={true} playsInline={true} loop={true} autoPlay={false}>
