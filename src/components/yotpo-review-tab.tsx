...
const YotpoReviewTab = (props) => {
    const { setActiveTab, activeTab, reviewBox, className, total, totalQa } = props;
    return (
        <ul className={`flex w-full border-[#f5dadf] border-b mt-3 ${className ?? ''}`} role="tablist" ref={reviewBox}>
