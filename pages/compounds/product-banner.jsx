  ...
  return (
    <div>
      ...
      <PDPBanner
        ...
        <h4 className="font-weight-normal mb-2 mb-lg-4"><b>Medium</b><br /> Gives skin a subtle glow. Great for lighter skin tones!</h4>
        <h4 className="font-weight-normal mb-2 mb-lg-4"><b>Dark</b><br /> For a back from vacay bronze. Ideal for medium skin tones!</h4>
        <h4 className="font-weight-normal mb-0"><b>Ultra Dark</b><br /> A deep, rich tan. For deeper skin tones!</h4>
			</PDPBanner>
      <PDPBanner
        background="bg-yellow-light"
				src="https://cdn.shopify.com/s/files/1/0075/2163/2309/files/Rectangle_2x_5d1af986-b009-4369-b374-0d6a620bf81d_828x.jpg?v=1585822408"
        ...
        <ul className="list-check mb-0 h4 font-weight-normal">
      ...
      <PDPBanner
        ...
        <h4 className="font-weight-normal mb-0">Our ultra hydrating water-based face tanner formula are easily mixable with your daily skincare routine.<br /><br />Just drop it
      ...
      <PDPBanner
        ...
        <h4 className="font-weight-normal">The story doesn’t end with a flake-free scalp. Our pre-shampoo scalp treatment promotes hair growth while giving your
      ...
      <PDPBanner
        ...
        <h4 className="font-weight-normal">Ramp up your skincare game with our triple exfoliating scrub. From achieving a perfect tan to firmer, youthful skin, our
      ...
      <PDPBanner
        ...
        <div className="bod-bundle-steps d-flex flex-wrap">
          ...
          <h4 className="mb-2 mb-lg-3">
            <b>Prep:</b>
            <span className="font-size-sm font-weight-normal d-block mt-1">Gently exfoliate dead cells & hydrate skin with volcanic pumice, & coconut oil.</span>
          </h4>
          ...
          <h4 className="mb-2 mb-lg-3">
            <b>Set:</b>
            <span className="font-size-sm font-weight-normal d-block mt-1">Deeply cleanse & even out skin tone with Volcanic clay, green coffee and algae.</span>
          </h4>
          ...
          <h4 className="mb-2 mb-lg-3">
            <b>Glow:</b>
            <span className="font-size-sm font-weight-normal d-block mt-1">Achieving visibly smoother & younger-looking skin with ultra nourishing body whip.</span>
          </h4>
        </div>
			</PDPBanner>
      <PDPBanner
        ...
        <div className="d-flex flex-wrap bali-bundle-variants mt-2 mt-lg-4 align-items-center">
          ...
          <h4 className="mb-2 mb-lg-4 col-10 pl-0">
