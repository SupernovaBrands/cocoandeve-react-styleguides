...
export default function Carousels() {
	...
	return (
		<Container className="pb-4">
			...
			<CarouselCustom id="loop1" useCardTemplate={true} items={carouselCustomItems} slideNumber={4} className="col-12 col-md-4" roundedControl={true} colLgGrid={3} useRow={true} />

			<h1 className="mt-5">CAROUSEL LOOP 4 ITEMS</h1>
			<CarouselCustom id="loop2" useCardTemplate={true} items={carouselCustomItems} slideNumber={4} className="col-12 col-md-3" roundedControl={true} colLgGrid={4} useRow={true} />

			<h1 className="mt-5">CAROUSEL LOOP 4 ITEMS CENTERED</h1>
			<CarouselCustom id="loop3" useCardTemplate={true} items={carouselCustomItems} slideNumber={4} centered={true} className="col-9 col-md-3" />
		</Container>
	);
}
