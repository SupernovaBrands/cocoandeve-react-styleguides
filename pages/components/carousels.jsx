...
export default function Carousels() {
	...
	return (
		<Container className="pb-4">
			...
			<CarouselCustom id="loop1" productCard={true} useCardTemplate={true} items={carouselCustomItems} slideNumber={4} className="col-12 col-md-4" roundedControl={true} colLgGrid={3} useRow={true} />
