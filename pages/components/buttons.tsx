	...
	return (
		<div className="container my-4">
			...
			<button className="bg-primary hover:bg-primary-darken rounded border border-transparent font-bold text-white py-[9px] px-[28px] flex items-center">
				Button With Icon <span className="ml-[4px] mt-[5px]"><Search className="h-[12px]" fill="white"/></span>
			</button>
			<br />
			<button className="bg-primary hover:bg-primary-darken rounded border border-transparent font-bold text-white py-[9px] px-[28px] flex items-center">
				Shop <span className="ml-[4px] mt-[5px]"><ChevronDown className="h-[12px]" fill="white"/></span>
			</button>
			<br />
			...
			<br />
			<button className="bg-transparent hover:bg-primary hover:text-white w-full rounded border border-primary font-bold text-primary py-[9px] px-[28px] mb-2 mt-[0.5rem]">
				Button Block
			</button>
			<br />
			<button className="bg-primary hover:bg-primary-darken w-full rounded-lg border border-transparent font-bold text-white py-[13px] px-[54px] mb-2 mt-[0.5rem]">
				Button Large Block
			</button>
			<br />
			<button className="bg-transparent hover:bg-primary hover:text-white w-full rounded-lg border-2 border-primary font-bold text-primary py-[13px] px-[54px]">
				Button Large Block
			</button>
		</div>
	);
